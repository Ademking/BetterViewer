...
function init(settings) {
  ...
  if (imgElement) {
    ...
    // Request from @skyfighteer
    // Do not allow the image to exit more than 90% of the screen
    let maxOffsetPercentage = 0.9 // max offset percentage;
    // init Viewer
    viewer = new Viewer(imgElement, {
      ...
      move: function (event) {
        ...
        let maxOffsetVertical = viewerData.height * maxOffsetPercentage
