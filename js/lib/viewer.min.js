...
!(function (t, e) {
    ...
    function kt(t) {
        var e = t.rotate,
            ...
            s = t.translateY,
            t = [];
        J(o) && 0 !== o && t.push("translateX(".concat(o, "px)")),
            J(s) && 0 !== s && t.push("translateY(".concat(s, "px)")),
            J(e) && 0 !== e && t.push("rotate(".concat(e, "deg)")),
            J(i) && 1 !== i && t.push("scaleX(".concat(i, ")")),
            J(n) && 1 !== n && t.push("scaleY(".concat(n, ")"));
    ...
    var It,
        At = {
            ...
            renderList: function () {
                ...
                n &&
                    ...
                    (e = n.offsetWidth),
                    rt(this.list, st({ width: (n = e + t) * this.length - t }, kt({ translateX: (this.viewerData.width - e) / 2 - n * i }))));
            },
            resetList: function () {
                var t = this.list;
                ...
                (this.imageInitializing = {
                    ...
                    (t = Dt(e, l, function (t, e) {
                        ...
                        l.rotatable && ((t.rotate = d.rotate || 0), (e.rotate = 0)),
                            l.scalable && ((t.scaleX = d.scaleX || 1), (t.scaleY = d.scaleY || 1), (e.scaleX = 1), (e.scaleY = 1)),
                            (h.imageData = t),
        ...
        r = {
            bind: function () {
                ...
                yt(e, O, (this.onClick = this.click.bind(this))),
                    ...
                    yt(i, X, (this.onPointerDown = this.pointerdown.bind(this))),
                    yt(n, M, (this.onPointerMove = this.pointermove.bind(this))),
                    yt(n, q, (this.onPointerUp = this.pointerup.bind(this))),
                    yt(n, F, (this.onKeyDown = this.keydown.bind(this))),
                    yt(window, P, (this.onResize = this.resize.bind(this))),
                    t.zoomable && t.zoomOnWheel && yt(e, j, (this.onWheel = this.wheel.bind(this)), { passive: !1, capture: !0 }),
            ...
            unbind: function () {
                var t = this.options,
                    ...
                    n = this.element.ownerDocument;
                wt(e, O, this.onClick),
                    wt(e, L, this.onDragStart),
                    wt(i, X, this.onPointerDown),
                    wt(n, M, this.onPointerMove),
                    wt(n, q, this.onPointerUp),
                    wt(n, F, this.onKeyDown),
                    wt(window, P, this.onResize),
                    t.zoomable && t.zoomOnWheel && wt(e, j, this.onWheel, { passive: !1, capture: !0 }),
        ...
        St = {
            show: function () {
                ...
                if ((nt(i.show) && yt(e, B, i.show, { once: !0 }), !1 === xt(e, B) || !this.ready)) return this;
                ...
                return (
                    n.transition && !t
                        ? ((o = function t(e) {
                          ...
                          this.viewed && ht(r, S) ? (yt(r, W, s, { once: !0 }), this.zoomTo(0, !1, null, !0)) : s())
                        : h(),
                    this
                );
            },
            view: function () {
                ...
                h && (ct(h, f), h.removeAttribute("aria-selected")),
                    lt(a, f),
                ...
                return (
                    this.viewed &&
                        ...
                        this.tooltipping
                            ...
                            : e.transition
                            ? (this.fading && xt(i, W), lt(i, A), lt(i, p), lt(i, S), i.removeAttribute("aria-hidden"), (i.initialOffsetWidth = i.offsetWidth), lt(i, z))
                            : (lt(i, A), i.removeAttribute("aria-hidden")),
                        ...
                        this.ready
                            ? ((o = []),
                              ...
                              this.isShown &&
                                  (this.length
                                      ? this.viewed &&
                                        (0 <= (t = o.indexOf(this.index))
                                            ? ((this.viewed = !1), this.view(Math.max(Math.min(this.index - t, this.length - 1), 0)))
                                            : (lt((t = this.items[this.index]), f), t.setAttribute("aria-selected", !0)))
        ...
        Ot = {
            ...
            shown: function () {
                ...
                (this.fulled = !0),
                    ...
                    nt(e.shown) && yt(t, "shown", e.shown, { once: !0 }),
            ...
            hidden: function () {
                ...
                e.fucus && this.clearEnforceFocus(),
                    ...
                    this.resetImage(),
                    (this.hiding = !1),
                    this.destroyed || (nt(e.hidden) && yt(t, "hidden", e.hidden, { once: !0 }), xt(t, "hidden", null, { cancelable: !1 }));
            },
            requestFullscreen: function (t) {
                var e = this.element.ownerDocument;
                this.fulled &&
                    !(e.fullscreenElement || e.webkitFullscreenElement || e.mozFullScreenElement || e.msFullscreenElement) &&
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.ready ||
                                ...
                                lt(n, s.title ? Tt(Array.isArray(s.title) ? s.title[0] : s.title) : y),
                                lt(a, s.navbar ? Tt(s.navbar) : y),
                                ut(m, y, !s.button),
                                    ...
                                    ? ((r = document.createElement("ul")),
                                      ...
                                      ot(h ? s.toolbar : $, function (t, e) {
                                          ...
                                          !o ||
                                              ...
                                              ((e = i && !Q(t.size) ? t.size : t),
                                              (i = i && !Q(t.click) ? t.click : t),
                                              (t = document.createElement("li")),
                                              s.keyboard && t.setAttribute("tabindex", 0),
                                              t.setAttribute("role", "button"),
                                              lt(t, "".concat(g, "-").concat(n)),
                                              nt(i) || ft(t, K, n),
                                              J(o) && lt(t, Tt(o)),
                                              -1 !== ["small", "large"].indexOf(e) ? lt(t, "".concat(g, "-").concat(e)) : "play" === n && lt(t, "".concat(g, "-large")),
                                              nt(i) && yt(t, O, i),
                                              r.appendChild(t));
                                      }),
                                      o.appendChild(r))
                                ...
                                s.inline
                                    ? (lt(m, w), rt(i, { zIndex: s.zIndexInline }), "static" === window.getComputedStyle(e).position && rt(e, { position: "relative" }), e.insertBefore(i, t.nextSibling))
                                    : (lt(m, v), lt(i, b), lt(i, p), lt(i, y), rt(i, { zIndex: s.zIndex }), (m = (m = _((m = s.container)) ? t.ownerDocument.querySelector(m) : m) || this.body).appendChild(i)),
                                s.inline && (this.render(), this.bind(), (this.isShown = !0)),
                                (this.ready = !0),
                                nt(s.ready) && yt(t, H, s.ready, { once: !0 }),
